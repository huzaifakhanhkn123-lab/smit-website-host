jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        transition:"tiles,blocks,elastic,threedflipwithzoom,threedwithzoom,flip,threedflip,cssslide,threedtiles,slide,crossfade,kenburns,threedhorizontalwithzoom,fade,shuffle,flipwithzoom,threedhorizontal,blinds,threed",
        scalemode:"fill",
        isfullscreen:false,
        textformat: {
